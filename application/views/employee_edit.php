            ...
            <form method="post" action="<?php echo $action; ?>">
                <div class="data">
                    <table>
                        <tr>
                            <td width="30%">ID</td>
                            <td><input type="text" name="employee_id" disabled="disable" 
                                       class="text" size="11"
                                       value="<?php echo set_value('employee_id', $employee_id); ?>"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td valign="top">Hire Date</td>
                            <td><input type="text" name="hire_date"
                                       class="text" size="15" 
                                       value="<?php echo set_value('hire_date', $hire_date); ?>"/>
                                       <a href="javascript:void(0);" onclick="displayDatePicker('hire_date');">
                                       <img src="<?php echo base_url(); ?>images/calendar.png" alt="calendar" border="0" /></a>
                        </tr>
                        <tr>
                            <td valign="top">Term Date</td>
                            <td><input type="text" name="term_date"
                                       class="text" size="15" 
                                       value="<?php echo set_value('term_date', $term_date); ?>"/>
                                       <a href="javascript:void(0);" onclick="displayDatePicker('term_date');">
                                       <img src="<?php echo base_url(); ?>images/calendar.png" alt="calendar" border="0" /></a>
                        </tr>
                        <tr>
